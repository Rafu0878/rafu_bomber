...
# GitHub: https://github.com/rafu0078-bot
# Version: 4.1.0
#########################################
...
def showAuthorMsg(msg):
    ...
    time.sleep(1)
    input("\n    \033[92m[\033[37m*\033[92m] \033[37mSAY I LOVE YOU TO RAFU  To Continue...")
    logo()
...
def logo():
    os.system("clear")
    print("\033[94m│ \033[95mAuthor : MR RAFU👾 Inc.                \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber⚠️          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : rafu_bot_0078 \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : 7234_ABRAHAM🥀              \033[37mV4.1 \033[94m│".center(columns+15))
...
def check(sent):
    ...
    if (sent == amount):
        ...
        time.sleep(0.6)
        print("\033[92m[\033[93m★\033[92m] Thanks For Using MR RAFU ✅ Tool \033[92m[\033[93m★\033[92m]".center(columns + 30))
        print("\033[37m")
